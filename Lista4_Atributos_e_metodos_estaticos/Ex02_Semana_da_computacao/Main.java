...
public class Main {
    public static void main(String[] args) {
        ...
        Participante vania = new Participante("Vania", "12345679", "vania@email.email");
        ...
        Participante gustavo = new Participante("Gustavo", "12345678", "gustavo@email.email");
        Participante claudia = new Participante("Claudia", "12345680", "claudia@email.email");
